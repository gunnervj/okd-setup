...
for f in user-data.template meta-data ubuntu-server.img; do
...
echo "OKD-SERVICES VM '${VM_NAME}' installation initiated."
echo "Waiting 10 minutes for OKD-SERVICES VM to finish initialization..."
sleep 600